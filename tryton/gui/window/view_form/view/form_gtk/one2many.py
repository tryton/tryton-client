...
def _create_menu(self):
    ...
    img_new = gtk.Image()
    img_new.set_from_stock('tryton-new', gtk.ICON_SIZE_MENU)
    ...
    img_open = gtk.Image()
    img_open.set_from_stock('tryton-open', gtk.ICON_SIZE_MENU)
    ...
    img_del = gtk.Image()
    img_del.set_from_stock('tryton-delete', gtk.ICON_SIZE_MENU)
    ...
    img_pre = gtk.Image()
    img_pre.set_from_stock('tryton-go-previous', gtk.ICON_SIZE_MENU)
    ...
    img_next = gtk.Image()
    img_next.set_from_stock('tryton-go-next', gtk.ICON_SIZE_MENU)
    ...
    img_switch.set_from_stock('tryton-fullscreen', gtk.ICON_SIZE_MENU)
