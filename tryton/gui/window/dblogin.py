...
class DBLogin(object):
    def __init__(self, parent):
        ...
        tooltips.set_tip(button_cancel, _('Cancel connection or reconnection to the Tryton server'))
        ...
        self.button_server = gtk.Button(label=_("C_hange"), stock=None,
            use_underline=True)
        tooltips.set_tip(self.button_server, _('Configure the Tryton server connection preferences'))
