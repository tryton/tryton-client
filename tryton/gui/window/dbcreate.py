...
class DBCreate(object):
    ...
    def __init__(self, sig_login):
        ...
        table.attach(label_server_setup, 0, 3, 0, 1, xoptions=gtk.EXPAND \
            | gtk.FILL)
        ...
        tooltips.set_tip(self.entry_server_connection, _("This is the URL of " \
        ...
        table.attach(self.button_server_change, 2, 3, 1, 2, xoptions=gtk.FILL)
        tooltips.set_tip(self.button_server_change, _("Setup the Tryton " \
        ...
        table.attach(label_serverpasswd, 0, 1, 2, 3)
        ...
        table.attach(self.entry_serverpasswd, 1, 3, 2, 3, yoptions=False,
            xoptions=gtk.EXPAND | gtk.FILL)
        tooltips.set_tip(self.entry_serverpasswd, _("This is the " \
        ...
        table.attach(hseparator, 0, 3, 3, 4, yoptions=False,
            xoptions=gtk.EXPAND | gtk.FILL)
        ...
        table.attach(label_dbname, 0, 3, 4, 5, xoptions=gtk.EXPAND \
            | gtk.FILL)
        ...
        table.attach(label_dbname, 0, 1, 5, 6, \
            xoptions=gtk.FILL)

        self.entry_dbname = gtk.Entry()
        self.entry_dbname.set_max_length(63)
        self.entry_dbname.set_width_chars(63)
        self.entry_dbname.set_activates_default(True)
        table.attach(self.entry_dbname, 1, 3, 5, 6, yoptions=False,
                    xoptions=gtk.EXPAND | gtk.FILL)
        tooltips.set_tip(self.entry_dbname, _("Choose the name of the new " \
            "database.\n" \
        ...
        table.attach(eventbox_language, 1, 3, 6, 7, \
            xoptions=gtk.EXPAND | gtk.FILL)
        tooltips.set_tip(eventbox_language, _("Choose the default " \
        ...
        tooltips.set_tip(self.entry_adminpasswd, _("Choose a password for " \
        ...
        table.attach(label_adminpasswd2, 0, 1, 8, 9, \
            xoptions=gtk.FILL)
        ...
        tooltips.set_tip(self.entry_adminpasswd2, _("Type the Admin " \
            "password again"), None)
        ...
        tooltips.set_tip(self.button_create, _('Create the new Tryton ' \
            'database.'))
