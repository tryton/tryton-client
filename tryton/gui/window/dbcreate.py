...
class DBCreate(object):
    ...
    def __init__(self, sig_login):
        ...
        table.attach(label_dbname, 0, 3, 4, 5)
        ...
        table.attach(label_language, 0, 1, 6, 7)
        ...
        table.attach(label_adminpasswd, 0, 1, 7, 8)
